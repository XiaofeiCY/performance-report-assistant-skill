...
## 研发证据摘要（有仓库时使用）
- [扫描范围]：[提交次数/涉及文件数/代码增删行/高频模块/作者分布/日期分布]。[说明它支撑的交付或问题闭环]
...
## 研发证据摘要（有仓库时使用）
- [周期内代码证据]：[提交次数/涉及文件数/代码增删行/高频模块/作者分布/日期分布]。[用一句话解释它支撑了什么业务或工程结果]
...
## 研发证据摘要（有仓库时使用）
- [对外可说的工程证据]：[提交次数/涉及模块/问题闭环/交付节奏]。[避免暴露内部敏感路径、分支名或代码细节]
...
## 研发证据摘要（有仓库时使用）
- [扫描范围]：[提交次数/涉及文件数/代码增删行/高频模块/作者分布/日期分布]。[说明它体现的职责范围、技术深度或交付稳定性]
